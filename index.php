        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.php" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">PIKA</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="index.php" class="menu-link">
                ...
                <div data-i18n="Analytics">Halaman Masyarakat</div>
              </a>
            </li>

            <!-- Layouts -->
            <li class="menu-item">
              <a href="layout.php" class="menu-link menu-toggle">
